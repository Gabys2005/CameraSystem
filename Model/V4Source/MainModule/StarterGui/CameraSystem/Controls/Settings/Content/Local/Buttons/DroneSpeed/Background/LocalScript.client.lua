...
local function slide(input)
	...
	local speed = scalePos * 2
	script.Parent.Parent.Parent.Parent.Parent.Parent.Parent.DroneSpeed.Value = speed
	script.Parent.Parent.Value.Text = roundDecimals(speed,2)
end
...
script.Parent.Parent.Reset.MouseButton1Click:Connect(function()
	script.Parent.Parent.Parent.Parent.Parent.Parent.Parent.DroneSpeed.Value = 1
end)