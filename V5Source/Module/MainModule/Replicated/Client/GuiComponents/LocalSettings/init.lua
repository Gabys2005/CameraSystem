...
return function()
	...
	switch({ Name = "Transparent blackout:", Setting = "Local.Settings.TransparentBlackout" }).Parent =
		copy.TopSwitches.TransparentBlackout
	switch({ Name = "Keybinds:", Setting = "Local.Settings.Keybinds" }).Parent = copy.TopSwitches.Keybinds
	dotslider({ Name = "Drone Speed", Min = 0, Max = 2, Round = 2, Setting = "Local.Settings.DroneSpeed" }).Parent =
		copy.SomeSlider
